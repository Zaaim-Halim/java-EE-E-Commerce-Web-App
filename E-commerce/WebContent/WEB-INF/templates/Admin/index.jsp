             ...
             <table class="table mt-4 jsmartable">
                    <thead>
                        <tr>
                            <th>Produit</th>
                            <th>Libelle</th>
                            <th data-breakpoint="xs">categories</th>
                            <th data-breakpoint="sm">Description</th>
                            <th data-breakpoint="md">Qty</th>
                            <th data-breakpoint="md">Prix</th>
                            <th data-breakpoint="md">Old Prix</th>
                    ...
                    <tbody>
                     ...
                     <c:forEach items = "${products}"  var="product">
                        <tr>
                           <td data-title="Rewrite column title">
                               <img src="data:image/jpeg;base64,${product.image}" data-lazy-type="image" height="80px" width="80px">
                             </td>
                            ...
                            <td>${product.price}</td>
                            <td>${product.oldPrice != null ? product.oldPrice : "non"}</td>
                            <td><a href="<c:url value ="/Admin-index?action=modifyP&id=${product.id}"/>" class="btn btn-success btn-sm">&nbsp; modifier &nbsp;</a></td>
                           
                            <td><a  href="<c:url value ="/Admin-index?action=deleteP&id=${product.id}"/>" class="btn btn-danger btn-sm"> supprimer</a> </td>
                        </tr>
                     </c:forEach>
                    </tbody>
                </table>
