...
<body class="app sidebar-mini rtl">
	...
	<c:import url="/WEB-INF/templates/Fragments/header.jsp">
		<c:param name="page" value="modifierP" />
	</c:import>

	<!-- Sidebar menu-->
	<div class="app-sidebar__overlay" data-toggle="sidebar"></div>
	<c:import url="/WEB-INF/templates/Fragments/aside.jsp">
		<c:param name="page" value="modifier" />
	</c:import>
	<main class="app-content">
		<div class="app-title">
			<div>
				<h1>
					<i class="fa fa-edit"></i> Modifier Produit
				</h1>
			...
			<ul class="app-breadcrumb breadcrumb">
				...
				<li class="breadcrumb-item"><a
					href="<c:url value ="/Admin-index"/>">Acceuil</a></li>
			</ul>
		</div>
		...
		<div class="row">
			<div class="col-md-12">
				<div class="tile">
					<div class="tile-body ext-center">Modifier Produit</div>
					<div class="row">
						<div class="col-lg-12">
							<form action="Admin-modifierProduit" method="post">
								<div class="form-group">
									<label for="exampleFormControlInput1">Nom Produit</label> <input
										type="text" class="form-control" id="exampleFormControlInput1"
										name="libelle" value="${product.libelle}" />
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									<label for="prix">Prix</label> <input type="number"
										class="form-control" id="prix" min="1"
										value="${product.price}" name="prix" />
								</div>
								<div class="form-group">
									<label for="prix">OldPrice </label> <input type="number"
										class="form-control" id="oldprice" 
										value="${product.oldPrice}" name="oldPrice" />
								</div>
								...
								<div class="form-group">
									<label for="exampleFormControlTextarea1">Produit
										Description</label>
									<textarea class="form-control" id="exampleFo" rows="3"
										 name="description">${product.description}</textarea>
								</div>
								<input type="number" hidden="hidden" name="id" value="${product.id}" />
								<button type="submit" class="btn btn-primary mb-2">Modifier
									Produit</button>
							</form>
						</div>
					</div>
