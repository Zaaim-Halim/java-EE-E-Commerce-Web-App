			...
			<div class="col-md-3 bg-white border rounded">
				...
				<form action="search" method="get">
					...
					<div class="form-row">
                         ...
                         <input type="text" class="form-control-sm" name="action" hidden="hidden"
							value="btnprice" />
						<input type="number" class="form-control-sm" name="price1"
						id="exampleInputPassword1" placeholder="prix2" />
						</div>
						<div class="col-md-6 mb-2">
							
							<input type="number" class="form-control-sm" name="price2"
								...
								<div class="modal-content">
									...
									<form action="cart" method="get">
                                         <div class="form-group">
                                          ...
                                          <input type="number" min="1" class="form-control-file" name="qty" id="qty"/>
